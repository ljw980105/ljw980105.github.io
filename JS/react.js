...
var ReactClassInterface = {
   ...
   * @return {boolean} True if the component should update_pseudo.
   * @optional
   */
  shouldComponentUpdate: 'DEFINE_ONCE',

  /**
   * Invoked when the component is about to update_pseudo due to a transition from
   * `this.props`, `this.state` and `this.context` to `nextProps`, `nextState`
   * and `nextContext`.
   *
   * Use this as an opportunity to perform preparation before an update_pseudo occurs.
   *
...
ReactComponent.prototype.setState = function (partialState, callback) {
  !(typeof partialState === 'object' || typeof partialState === 'function' || partialState == null) ? "development" !== 'production' ? invariant(false, 'setState(...): takes an object of state variables to update_pseudo or a function which returns an object of state variables.') : _prodInvariant('85') : void 0;
 ...
 *
 * @param {?function} callback Called after update_pseudo is complete.
 * @final
 * @protected
 */
...
/**
 * This is the abstract API for an update_pseudo queue.
 */
